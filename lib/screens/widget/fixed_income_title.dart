...
class FixedIncomeTitle extends StatelessWidget {
  final FixedIncomeModel model;
  final VoidCallback onTap;

  const FixedIncomeTitle({
    Key? key,
    required this.model,
    required this.onTap,
  }) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    model.type.text(context),
                    style: const TextStyle(color: Colors.black38),
                  ),
                ),
                Text(
                  '${model.type == FixedIncomeType.eachYear ? '${model.month} /' : ''} ${model.day}',
            ...
            Row(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: model.amount < 0 ? Colors.redAccent : Colors.blueAccent,
                    fontSize: 18,
                  ),
                ),
                const SizedBox(width: 8),
